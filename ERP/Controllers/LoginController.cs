    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult Getcode(Login s)
        {
            try
            {
                ...
                if (WSConfig.MailFunction(("Dear Staff Member, Your start key for KENYA FILM COMMISSION portal is  " + text) ?? "", email, "Portal password reset successful") && !string.IsNullOrEmpty(email))
                {
